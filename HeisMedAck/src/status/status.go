...
func handleMessage(sendChan chan []byte, doorTimerChan chan string, elevatorIP string, floor int, buttonType int, MessageType string) {
	switch (MessageType) {
	case "":
...
func EventHandler(sendChan chan []byte, upButtonChan chan int, downButtonChan chan int,
	...
	for {
		...
		case message = <- receiveChan:
			...
			handleMessage(sendChan, doorTimerChan, elevator, floor, buttonType, MessageType)
